h3. Note - This demo is not up to date with the current chargify gem and API. Please see "Chargify":http://docs.chargify.com for the current API documentation.
